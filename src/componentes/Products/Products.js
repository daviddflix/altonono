    ...
    <div className={s.mainBox}>
      <div className={s.containerInput}>
        ...
        <input
          ...
          value={finder}
          className={s.input}
          placeholder="Encuentra productos por su nombre"
      ...
      {items.length ? (
        ...
        <div className={s.containerSpinner}>
          <Spinner />
        </div>
      )}
    </div>
...
function Card({
  ...
  return (
    <div className={available === false ? s.unavailable : s.boxProduct}>
      ...
      <div className={s.boxTitle2}>
        <div className={s.btnBox}>
          <button
            ...
            onClick={ProductNumberDecrement}
            className={s.btn}
          >
            <AiOutlineMinus />
          </button>
          <p className={s.btn}>
            {findQuantity !== undefined ? findQuantity.quantity : 0}
          </p>
          <button
            disabled={available === false || status === "Cerrado"}
            onClick={ProductNumberIncrement}
            className={s.btn}
          >
            <TbPlus />
          </button>
      ...
      {available === false && (
        <span className={s.itemUnavailable}>No Disponible</span>
      )}
    </div>
  );
}
